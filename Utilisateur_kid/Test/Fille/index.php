  ...
  <aside id="sidebar">
    <center><img src="../../../images/fille.png" class="nom_util" alt="Photo de l'utilisateur">
      ...
      <?php if ($Type === 'Admin'): ?>
        ...
        <?php endif; ?>
        <a href="../../acceuil/Fille/index.php" class="btn2"><p class='prof'>Accueil</p></a>
...
<section>
    ...
    <div class="container1">
      ...
      <div class="container1">
      <a href='../../../LesTest/gramg/test2gramg.php'><div class="box">
          <img src="../../../images/pluriel.gif">
        </div></a>
        <a href='../../../LesTest/gramg/test1gramg.php'><div class="box">
          <img src="../../../images/article.gif">
        </div></a>
        <a href='../../../LesTest/gramg/test3gramg.php'><div class="box">
          <img src="../../../images/Mascfim.gif">
        </div></a>
      </div>
      <h3 class='titre'>Conjugaison</h3>
      <div class="container1">
      <a href='../../../LesTest/conjg/presentg.php'><div class="box">
          <img src="../../../images/conjugaison1.gif">
        </div></a>
        <a href='../../../LesTest/conjg/passecompg.php'><div class="box">
          <img src="../../../images/conjugaison2.gif">
        </div></a>
        <a href='../../../LesTest/conjg/imparfaitg.php'><div class="box">
          <img src="../../../images/conjugaison3.gif">
        </div></a>
      </div>
      <div class="container1">
      <a href='../../../LesTest/conjg/futurg.php'><div class="box">
          <img src="../../../images/conjugaison4.gif">
        </div></a>
        <a href='../../../LesTest/conjg/passesimpleg.php'><div class="box">
      ...
      <div class="container1">
      <a href='../../../LesTest/testg/test1.php'><div class="box">
          <img src="../../../images/aud.gif">
        </div></a>
        <a href='../../../LesTest/testg/test2.php'><div class="box">
          <img src="../../../images/img.gif">
        </div></a>
        <a href='../../../LesTest/testg/test3.php'><div class="box">
          <img src="../../../images/color.gif">
        </div></a>
      </div>
      <div class="container1">
      <a href='../../../LesTest/testg/test4.php'><div class="box">
  ...
  <div class="footer">
    <footer class="footer">
        ...
        <ul class="menu">
          <li class="menu__item"><a class="menu__link" href="../../acceuil/Fille/index.php">Acceuil</a></li>
