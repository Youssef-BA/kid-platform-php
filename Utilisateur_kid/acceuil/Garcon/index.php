...
<header class="masthead">
            <div class="container">
                ...
                <a class="button" href="../../A propos de nous/Garcon/index.php"><i class="vid">À propos de nous</i></a>
            </div>
</header>
<section>
  <div class="text-center">
    ...
    <div class="container1">
        <a href="../../../video cours/Garcon/maths.html"><div class="box">
          <img src="../../../images/Math.gif">
        </div></a>
        <a href="../../../video cours/Garcon/grammaire.html"><div class="box">
        <img src="../../../images/gramm.gif">
        </div></a>
        <a href="../../../video cours/Garcon/culture.html"><div class="box">
        <img src="../../../images/Addition (9).gif">
      </div></a>
      <a class="button5" href="../../Cours/Garcon/index.php"><i class="vid">Voir plus..</i></a>
      <h1 class='color'>--------</h1>
    ...
    <a href='../../../LesTest/Math/Addition/html.php'><div class="box">
        ...
        <a href='../../../LesTest/conjb/presentb.php'><div class="box">
          <img src="../../../images/conjugaison1.gif">
        </div></a>
        <a href='../../../LesTest/gramb/test2gramb.php'><div class="box">
          <img src="../../../images/pluriel.gif">
        </div></a>
      </div>
      <a class="button11" href="../../Test/Garcon/index.php"><i class="vid">Voir plus..</i></a>
  </section>
  <div class="footer">
    <footer class="footer">
        <div class="waves">
        ...
        <ul class="menu">
          ...
          <li class="menu__item"><a class="menu__link" href="#">Video explicatif</a></li>
